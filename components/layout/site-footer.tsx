    ...
    <footer className="border-t border-gray-800 bg-gray-900 py-8">
      <div className="container grid grid-cols-1 gap-8 md:grid-cols-4">
        <div className="space-y-3">
          <h3 className="text-lg font-bold">Streemz</h3>
          <p className="text-sm text-gray-400">
            The first decentralized music platform that rewards artists fairly
            through Superfluid streaming payments.
          </p>
        </div>
        <div>
      ...
      <div className="container mt-8 border-t border-gray-800 pt-8">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Streemz. All rights reserved.
          </p>
          <div className="flex space-x-4">
            ...
            >
              <svg
                ...
                className="h-5 w-5"
              >
                <path d="M18 9a5 5 0 0 0-5-5H7a5 5 0 0 0-5 5v6a5 5 0 0 0 5 5h6a5 5 0 0 0 5-5V9Z" />
                <path d="M9 12h6" />
                <path d="M12 9v6" />
              </svg>
            </a>
